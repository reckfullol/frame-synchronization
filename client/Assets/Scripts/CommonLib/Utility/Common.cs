...
namespace CommonLib.Utility {
    public class CommonFunction {
        ...
        /// 逻辑帧率， 要大于等于30
        /// </summary>
        private const int _FRAME_RATE = 30;
        public const float GAME_TIME_PRE_FRAME = 1f / _FRAME_RATE;
        /// <summary>
        /// 动画的帧率，定死30
        /// </summary>
        private const int _ANIMATION_RATE = 30;
        public const float ANIMATION_TIME_PRE_FRAME = 1f / _ANIMATION_RATE;
        ...
        /// <returns></returns>
        private static uint ApolloHash(string str) {
            if (str == null) {
                return 0;
            }
        ...
        public static void Swap(ref uint t1, ref uint t2) {
            t1 ^= t2;
            t2 ^= t1;
            t1 ^= t2;
        }
        ...
        private static bool Clockwise(Vector2 fiduciary, Vector2 relativity) {
            float r = fiduciary.y * relativity.x - fiduciary.x * relativity.y;
            return r > 0;
        }
        public static uint NewID { get; } = ++_newId;
        ...
        /// </summary>
        /// <returns></returns>
        private static float GetAngle(Vector2 dir) {
